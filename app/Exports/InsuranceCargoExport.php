...
class InsuranceCargoExport implements FromView
{
    ...
    public function view(): View
    {
        ...
        $query = DB::table('insurance_cargo_items')
          ...
          ->leftJoin('insurance_cargos', 'insurance_cargo_items.insurance_cargo_id', '=', 'insurance_cargos.id')
          ...
          ->whereBetween('insurance_cargos.created_at', [$start , $end])
          ->get();
        ...
        return view('exports.insurance_cargo', [
            'insurance'  => $result ,
        ]);
