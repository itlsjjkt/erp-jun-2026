...
<body>
    ...
    <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="vertical-align: top;">
                    <table class="no-border" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="border: none">: {{$cdpm4+($cdpm1-$capdpm)+$cdpm5}}</td>
                        </tr>
                    </table>
                </td>                               
                <td style="vertical-align: top;">
                    <table class="no-border" style="width: 100%;">
                        <tr>
                            <td style="border: none">Elevated To PO</td>
                            <td style="border: none">: {{$cpr0}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">On Proggress</td>
                            <td style="border: none">: {{$cpr1}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">PR Parsial</td>
                            <td style="border: none">: {{$cpr2}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">Revisi</td>
                            <td style="border: none">: {{$cpr3}}</td>
                        </tr>
                        <tr>
                ...
                <td style="vertical-align: top;">
                    <table class="no-border" style="width: 100%;">
                        <tr>
                            <td style="border: none">Draft</td>
                            <td style="border: none">: {{$cpo0}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">On Progress</td>
                            <td style="border: none">: {{$cpo1}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">PO Issued</td>
                            <td style="border: none">: {{$cpo2}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">Perbaikan</td>
                            <td style="border: none">: {{$cpo3}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">LPB Parsial</td>
                            <td style="border: none">: {{$cpo4}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">Done</td>
                            <td style="border: none">: {{$cpo5}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">Cancel</td>
                            <td style="border: none">: {{$cpo6}}</td>
                        </tr>
                    </table>
                </td>
                <td style="vertical-align: top;">
                    <table class="no-border" style="width: 100%;">
                        <tr>
                            <td style="border: none">Draft</td>
                            <td style="border: none">: {{$clpb0}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">Published</td>
                            <td style="border: none">: {{$clpb1}}</td>
                        </tr>
                    </table>
                </td>
                <td style="vertical-align: top;">
                    <table class="no-border" style="width: 100%;">
                        <tr>
                            <td style="border: none">Draft</td>
                            <td style="border: none">: {{$cspb0}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">Published</td>
                            <td style="border: none">: {{$cspb1}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">BPB Parsial</td>
                            <td style="border: none">: {{$cspb2}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">BPB Done</td>
                            <td style="border: none">: {{$cspb3}}</td>
                        </tr>
                        <tr>
                            <td style="border: none">Reversal</td>
                            <td style="border: none">: {{$cspb4}}</td>
                        </tr>
                    </table>
                </td>
                <td style="vertical-align: top;">
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-center">{{$cpo}}</td>
                <td class="text-center">{{$clpb}}</td>
                <td class="text-center">{{$cspb}}</td>
    ...
    <div class="col-mb-3">
        ...
        <table class="no-border" style="width: 40%;">
            ...
            <tr>
                <td style="border: none">LPB</td>
                <td style="border: none">: Laporan Penerimaan Barang</td>
            </tr>
            <tr>
                <td style="border: none">SPB</td>
                <td style="border: none">: Surat Pengantar Barang</td>
            </tr>
            <tr>
                <td style="border: none">BPB Jakarta</td>
                <td style="border: none">: Bukti Penerimaan Barang Jakarta</td>
            </tr>
            <tr>
                <td style="border: none">BPBL</td>
                <td style="border: none">: Bukti Penerimaan Barang Lokal</td>
            </tr>
        </table>
    </div>
