	...
	<div class="row mB-40">
        ...
        <div class="col-sm-12">
            <div class="bgc-white p-20 bd">
                ...
                <h6><a class="float-left" href="{{ route('master.item_products.index') }}"><i class="ti-arrow-left mR-10"></i></a> Kembali</h6>
                <hr class="mB-30">

                {!! Form::open(['method' => 'POST', 'route' => ['master.item_products.import'],'enctype' =>'multipart/form-data']) !!}

                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label text-right">Kategori Produk<span class="text-danger">*</span></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <p>Gunakan Template ini untuk mengisi Data dari Upload 
                                <a download href="{{ asset('docs/template-product.xlsx') }}" class="text-success"> <i class="fa fa-file-excel-o"></i> Download</a> <br>
                            </p>
                        </div>
                    </div>
