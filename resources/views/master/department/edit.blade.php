...
@section('page-header')
    Kapal <small>{{ trans('app.update_item') }}</small>
@stop
        ...
        <div class="bgc-white p-30 bd">
			...
			!!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="checkbox" name="status" class="switch switch-info" id="status"  value="{{ $department->status or '0'}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="checkbox" name="isdpm" id="isdpm" style="transform: scale(2)" value="{{1}}" {{$department->isdpm==1 ?'checked':''}}>
                    </div>
                </div>
