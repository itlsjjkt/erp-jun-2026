	...
	<div class="col-sm-9">
        <div class="bgc-white p-30 bd">
            ...
            <hr class="mB-30">
                ...
                {!! Form::open(['method' => 'POST', 'route' => ['department.import'],'enctype' =>'multipart/form-data']) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <p>Gunakan Template ini untuk mengisi Data dari Upload 
                                <a download href="{{ asset('docs/template-department.xlsx') }}" class="text-success"> <i class="fa fa-file-excel-o"></i> Download</a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <a href="{{ route('department.index') }}" class="btn btn-light text-uppercase fsz-sm fw-600">{{ trans('Cancel') }}</a>
