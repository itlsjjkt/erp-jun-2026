...
<div class="row mB-40">
	...
	<div class="col-sm-12">
        <div class="bgc-white p-30 bd">
            ...
            {!! Form::model($expedition, [
                    'route' => ['master.expeditions.update', $expedition->id],
					'method' => 'put', 
					'files' => true
				])
			!!}
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="checkbox" name="is_handcarry" class="switch switch-info" id="is_handcarry" value="{{ $expedition->is_handcarry or '0'}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="checkbox" name="status" class="switch switch-info" id="status" value="{{ $expedition->status or '0'}}">
                            <p class="help-block"></p>
