...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('master.measures.index') }}">Satuan</a></li>
	...
	<div class="row mB-40">
        ...
        <div class="col-sm-12">
            <div class="bgc-white p-20 bd">
                ...
                <hr class="mB-30">
                {!! Form::open(['method' => 'POST', 'route' => ['master.measures.import'],'enctype' =>'multipart/form-data']) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <p>Gunakan Template ini untuk mengisi Data dari Upload 
                                <a download href="{{ asset('docs/template-measure.xlsx') }}" class="text-success"> <i class="fa fa-file-excel-o"></i> Download</a>
                            </p>
                        </div>
                    </div>
