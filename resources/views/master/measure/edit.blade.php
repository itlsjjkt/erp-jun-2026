...
@section('page-header')
    Satuan <small>{{ trans('app.update_item') }}</small>
@stop

@section('breadcrumbs')
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route(ADMIN . '.dashboard') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('master.measures.index') }}">Master Sataun</a></li>
...
<div class="row mB-40">
	...
	<div class="col-sm-12">
        <div class="bgc-white p-30 bd">
            ...
            {!! Form::model($items, [
                    'route' => ['master.measures.update', $items->id],
					'method' => 'put', 
					'files' => true
				])
			!!}
