...
<div class="row mt-5">
    <div class="col-lg-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9 checkbox-custom">
                <input class="checkbox-tools" type="radio" name="time_method" id="time_method-1" value="number" {{ ($item) ? ($item->time_method == 'number') ? "checked" : "" : "checked" }}>
    ...
    <div class="col-6">
        ...
        <h6 class="font-weight-bold">Metode Depresiasi</h6>
        <hr>

        <div class="form-group row">
            <label class="col-sm-3"> Metode</label>
            <div class="col-sm-9 checkbox-custom">
                <input class="checkbox-tools" type="radio" name="compute_method" id="compute_method-1" value="linier" {{ ($item) ? ($item->compute_method == 'linier') ? "checked" : "" : "checked" }}>
