...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('purchasing.payment_methods.index') }}">Price Term</a></li>
	...
	<div class="row mB-40">
        ...
        <div class="col-sm-9">
            ...
            <div class="bgc-white p-20 bd">
                ...
                <h6><a class="float-left" href="{{ route('purchasing.payment_methods.index') }}"><i class="ti-arrow-left mR-10"></i></a> Price Term</h6>
                <hr class="mB-30">

                {!! Form::open(['method' => 'POST', 'route' => ['purchasing.payment_methods.store']]) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
	                        <a href="{{ route('purchasing.payment_methods.index') }}" class="btn btn-light">{{ trans('Cancel') }}</a>
