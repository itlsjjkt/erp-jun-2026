...
<div class="row mB-40">
    ...
    <div class="col-sm-9">
        <div class="bgc-white p-30 bd">
            <h6><a class="float-left" href="{{ route('purchasing.po_notes.index') }}"><i class="ti-arrow-left mR-10"></i></a> Purchase Order Notes</h6>
            <hr class="mB-30">

            {!! Form::model($supplier, [
                    'route' => ['purchasing.po_notes.update', $supplier->id],
                    'method' => 'put', 
                    'files' => true
                ]);
            !!}
