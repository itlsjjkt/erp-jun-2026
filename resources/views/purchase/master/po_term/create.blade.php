...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('purchasing.po_terms.index') }}">Purchase Order Term</a></li>
	...
	<div class="row mB-40">
        ...
        <div class="col-sm-9">
            <div class="bgc-white p-20 bd">
                ...
                <h6><a class="float-left" href="{{ route('purchasing.po_terms.index') }}"><i class="ti-arrow-left mR-10"></i></a> Purchase Order Term</h6>
                <hr class="mB-30">

                {!! Form::open(['method' => 'POST', 'route' => ['purchasing.po_terms.store']]) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
	                        <a href="{{ route('purchasing.po_terms.index') }}" class="btn btn-light">{{ trans('Cancel') }}</a>
