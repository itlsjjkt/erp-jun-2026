...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('purchasing.payment_methods.index') }}">CC Email PO</a></li>
	...
	<div class="row mB-40">
        ...
        <div class="col-sm-9">
            <div class="bgc-white p-20 bd">
                ...
                <hr class="mB-30">
                {!! Form::open(['method' => 'POST', 'route' => ['purchasing.po_post_mails.store']]) !!}
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            $('.status_').select2().on('change', function() {
                $(this).valid();
            });
        });
    </script>
