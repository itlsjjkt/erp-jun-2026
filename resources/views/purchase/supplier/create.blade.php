                ...
                {!! Form::open(['method' => 'POST', 'route' => ['purchasing.suppliers.store']]) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            ...
                            {!! Form::select('payment_method_id', $payment_method, old('payment_method_id'), ['class' => 'form-control select2 payment_method', 'required' => '']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            {!! Form::submit(trans('Submit'), ['class' => 'btn btn-success', 'id' => 'btnSubmit']) !!}                        </div>
                    </div>
