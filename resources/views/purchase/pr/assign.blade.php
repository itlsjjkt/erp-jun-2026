	...
	<div class="bgc-white p-30 bd">
		...
		<div class="tab-content mT-30" >
  			<div class="tab-pane active" id="tab1" role="tabpanel" aria-labelledby="tab1">
				...
				@endif
                <hr>
                {!! Form::open(['method' => 'POST', 'route' => ['purchasing.pr.assign'], 'id' => 'form-pr']) !!}
					...
					<div class="alert alert-info my-4">
						<p class="m-0">Silahkan Checklist Item PR yang akan di assign</p>
					 </div>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @php
                                $sortedItems = $pr->assignItem->sortBy(fn($item) => $item->product->code.'-'.$item->product->name);
                            @endphp
