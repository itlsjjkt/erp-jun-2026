    ...
    <div class="bgc-white bd bdrs-3 p-20 mB-20">
        <div class="row">
            <div class="col-sm-12">
                ...
                <form class="form-horizontal" target="_blank" action="{{ route('purchasing.po.print.merge')}}" method='POST'>
                    {{ csrf_field() }}
                ...
                <div class="bd p-20">
                    <div class="form-group row">
                        @if(Auth::user()->data_access == 1)
                            <div class="col-2">
                                ...
                                {!! Form::select('purchaser_id', $purchaser, old('purchaser_id'), ['class' => 'form-control select2']) !!}
                            </div>
                        @endif
                        <div class="col-2">
                            <label>Project</label>
                        ...
                        <div class="col-2">
                            ...
                            {!! Form::select('supplier_id', $supplier, old('supplier_id'), ['class' => 'form-control select2']) !!}
                        </div>
                        <div class="col-3">
                            <label>Periode</label>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <button type="submit" class="btn" style="background-color: #be25cc; color:white"  id="btn-export-item-2-admin">Rekap PO (Admin)</button>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                <div class="layers bd p-20">
                    <div class="layer w-100">
                        <h6 class="mb-0">PO Issued</h6>
                    </div>
                    <div class="layer w-100">
                        <div class="peer peer-greed">
                            <h5 class="font-weight-bold fa-2x mb-0 text-warning">{{ $statistic[0]->issued }}</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="layers bd p-20">
                    <div class="layer w-100">
                        <h6 class="mb-0">Lpb Parsial</h6>
                    </div>
                    <div class="layer w-100">
                        <div class="peer peer-greed">
                            <h5 class="font-weight-bold fa-2x mb-0 text-primary">{{ $statistic[0]->lpb_parsial }}</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                <div class="layers bd p-20">
                    <div class="layer w-100">
                        <h6 class="mb-0">Cancel Revisi</h6>
                    </div>
                    <div class="layer w-100">
                        <div class="peer peer-greed">
                            <h5 class="font-weight-bold fa-2x mb-0 text-danger">{{ $statistic[0]->revised_closed }}</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="layers bd p-20">
                    ...
                    <div class="layer w-100">
                        <div class="peer peer-greed">
                            <h5 class="font-weight-bold fa-2x mb-0 text-warning">{{ $statistic[0]->draft }}</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="table-responsive mt-5" style="overflow-y: hidden !important;" >
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table =  $('#dataTables').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('purchasing.po.datatables') }}',
                "pageLength": 50,
                'columnDefs': [{
                    'targets': 0,
                    'searchable': false,
            ...
            $(document).on('click', "#btn-export-item-2-admin", function(e) {
                $('input[name="statusExport"]').val('0');
                e.preventDefault();
                $('form#form').attr('action',"{{ route('purchasing.po.export_2_admin') }}");
                if($('form#form').valid()){
                    $('form#form').submit();
                }
            });
