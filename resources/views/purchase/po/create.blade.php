                    ...
                    @if (count($pr_items) > 0)
                        ...
                        @foreach ($pr_items as $item)
                                <tr>
                                    ...
                                    <td><input type="text" name="total_price[]" readonly class="form-control text-right totalPrice"  id="totalPrice_{{ $item->id }}" value="0"> </td>
                                </tr>
                                @php
                                    $no++
                                @endphp
...
<script  type='text/javascript'>
	...
	$(document).ready(function() {
        ...
        supplier.select2({
            ...
            if(is_ppn === 1 || is_ppn === 11 || is_ppn === 12){
                $('#ppn').prop('checked', true);
                $("#ppn" ).attr('value', '1');
            }else{
                $('#ppn').prop('checked', false);
