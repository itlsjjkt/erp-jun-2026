...
@section('content')
    ...
    <div class="bgc-white bd bdrs-3 p-20 mB-20">
        ...
        @if(!Gate::allows('pr_monitoring'))
            <div class="mB-20 row">
                <div class="col-lg-12">
                    <a href="{{ route('purchasing.monitoring_pr') }}" class="nav-link float-left"><i class="ti-arrow-left"></i> Kembali</a>
                ...
                <div class="bd p-20">
                    <div class="form-group row">
                        <div class="col-auto">
                            ...
                            {!! Form::select('assigned_id', $purchaser, $data['assigned_id'], ['class' => 'form-control select2']) !!}
                        </div>
                        <div class="col-auto">
                            <label>Tipe PR</label>
    ...
    <script>
        $(document).ready(function() {
            $('#dataTables').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('purchasing.monitoring_pr.datatables',$query) }}',
                "pageLength": 50,
                columns: [
