...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tanda Terima Barang (TTB)</li>
    </ol>
@endsection
...
<div class="row mB-40">
	...
	<div class="col-sm-12">
        <div class="bgc-white p-30 bd">
            ...
            <div class="alert alert-info">Pembuatan Tanda Terima Barang (TTB) dilakukan di Menu Inventory</div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTables').DataTable({
                ...
                serverSide: true,
                "pageLength": 50,
                ajax: '{{ route('logistic.ttb.datatables') }}',
                columns: [
