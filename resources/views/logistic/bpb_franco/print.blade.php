        ...
        <div class="p-30">
            <table class="table border-0">
                <tr>
                    <td class="border-0 p-0" style="width:80px">
                        <img src="{{ asset('images/logo-shipping.jpeg') }}" alt="Logo" style="width:80px;left:10px;">
                    </td>
                ...
                <tr>
                    <td class="border-0" style="width:45%; vertical-align:top;">
                        <table class="border-0 table">
                            <tr>
                                <td class="border-0 p-0" style="width:150px;">Nomor PO</td>
                                <td class="border-0 p-0">: {{ $bpb->purchaseOrder->doc_no }}</td>
                            </tr>
                            <tr>
                                <td class="border-0 p-0">Nomor PR</td>
                                <td class="border-0 p-0">: {{ $bpb->purchaseOrder ? $bpb->purchaseOrder->purchaseRequisition->doc_no : '' }}</td>
                            </tr>
                            <tr>
                                <td class="border-0 p-0">Nomor DPM</td>
                                <td class="border-0 p-0">: {{ $bpb->purchaseOrder ? $bpb->purchaseOrder->purchaseRequisition->dpm_no : '' }}</td>
                            </tr>
                            <tr>
                                <td class="border-0 p-0">Supplier</td>
                                <td class="border-0 p-0">: {{ $bpb->purchaseOrder ? $bpb->purchaseOrder->supplier->name : '' }}</td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td class="border-0" style="width:35%; vertical-align:top;">
                        <table class="border-0 table">
                            <tr>
                                ...
                                <td class="border-0 p-0">: {{ $bpb->creator ? $bpb->creator->name : '' }}</td>
                            </tr>
                            <tr>
            ...
            <table class="table table-bordered mt-4"
                ...
                <tbody>
                    ...
                    <tr>
                        @if($sameUser)
                            <td class="text-center">{{ $bpb->creator ? $bpb->creator->name : '-' }}</td>
                        @else
                            <td class="text-center">{{ $bpb->creator ? $bpb->creator->name : '-' }}</td>
