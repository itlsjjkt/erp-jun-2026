		...
		<table class="table border-0">
			<tr>
				...
				<td class="border-0 text-right"> 
					<span style="font-weight:bold; font-size: 17px;text-decoration:underline"> ASURANSI CARGO </span> <br>
					{{ $insurance->doc_no }}
				</td>
			</tr>
			...
			<tr>
				<td class="border-0" style="width:33.3%"> 
					<table class="border-0 table">
						<tr>
							<td class="border-0 p-0">Ekspedisi</td>
							<td class="border-0 p-0">: {{ $insurance->expedition }} </td>
						</tr>
						<tr>
							<td class="border-0 p-0">Periode</td>
							<td class="border-0 p-0">: {{ date('d/m/Y',strtotime($insurance->period)) }} </td>
						</tr>
				...
				<td class="border-0" style="width:33.3%"> 
					<table class="border-0 table">
						<tr>
							<td class="border-0 p-0">Risk Location</td>
							<td class="border-0 p-0">: {{ $insurance->risk_location }} </td>
						</tr>
						<tr>
