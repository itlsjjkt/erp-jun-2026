...
@section('content')
    {!! Form::open(['method' => 'GET', 'route' => ['logistic.insurance_cargo.create'], 'id' => 'formSPB']) !!}
        ...
        <div class="alert alert-info mT-3">
           Berikut daftar SPB yang belum diterbitkan Asuransi Cargo, Silahkan Checklist Minimal 1 SPB. 
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table =  $('#dataTables').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('logistic.insurance_cargo.list.datatables') }}',
                "pageLength": 50,
                'columnDefs': [{
                    'targets': 0,
                    'searchable': false,
