...
@section('content')
    {!! Form::open(['method' => 'GET', 'route' => ['logistic.insurance_unit.create'], 'id' => 'formSPB']) !!}
	    <div class="bgc-white p-30 bd">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <input class="btn btn-danger text-uppercase fsz-sm fw-600 float-right" type="submit" id="btn-close" value="TUTUP SPB">
        ...
        <div class="alert alert-info mT-3">
           Berikut daftar SPB yang belum diterbitkan Asuransi Unit, Silahkan Checklist Minimal 1 SPB. 
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table =  $('#dataTables').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('logistic.insurance_unit.list.datatables') }}',
                "pageLength": 50,
                'columnDefs': [{
                    'targets': 0,
                    'searchable': false,
