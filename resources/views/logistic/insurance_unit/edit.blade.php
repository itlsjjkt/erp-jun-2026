...
<div class="mB-40">
		{!! Form::model($insurance, [
				'action' => ['Logistic\InsuranceUnitController@update', $insurance->id],
				'method' => 'put', 
		...
		!!}
            <div class="bgc-white p-30 bd">
                <h6>Edit Asuransi Unit: {{ $insurance->doc_no }}</h6>
                <hr class='mB-30'>
    
                <div class="form-group row">
                    <label class="col-sm-2 ">Kepada<span class="text-danger">*</span></label>
                    <div class="col-sm-4">
                        {!! Form::text('kepada', old('kepada'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 ">CC<span class="text-danger">*</span></label>
                    <div class="col-sm-6">
                        {!! Form::text('cc', old('cc'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 ">Perihal<span class="text-danger">*</span></label>
                    <div class="col-sm-6">
                        {!! Form::text('perihal', old('perihal'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    </div>
                </div>
                <div class="form-group row">
