...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Asuransi Unit</li>
    </ol>
@endsection
...
@section('content')
    ...
    <div class="bgc-white bd bdrs-3 p-20 mB-20">
        ...
        <div class="mB-20">
            <a href="{{ route('logistic.insurance_unit.list') }}" class="btn btn-info">
                Buat Asuransi
            </a>
        ...
        <div class="collapse mB-20" id="export" aria-expanded="false">
            <form class="form-horizontal" action="{{ route('logistic.insurance_unit.export')}}" method='POST'>
                {{ csrf_field() }}
    ...
    <script>
        $(document).ready(function() {
            $('#dataTables').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('logistic.insurance_unit.datatables') }}',
                "pageLength": 50,
                columns: [
                    {data: 'doc_no', name: 'doc_no'},
                    {data: 'kepada', name: 'kepada', searchable: false},
                    {data: 'cc', name: 'cc', searchable: false},
                    {data: 'perihal', name: 'perihal', searchable: false},
