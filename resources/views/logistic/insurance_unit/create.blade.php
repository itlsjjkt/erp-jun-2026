...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('logistic.insurance_unit.index') }}">Asuransi Unit</a></li>
...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['logistic.insurance_unit.store'], 'files' => true]) !!}
	...
	<div class="bgc-white p-30 bd">
        ...
        <h6 class='mT-10'>Form Asuransi Unit</h6>
        <hr>
        <div class="form-group row">
            <label class="col-sm-2 ">Kepada<span class="text-danger">*</span></label>
            <div class="col-sm-4">
                {!! Form::text('kepada', old('kepada'), ['class' => 'form-control', 'placeholder' => '','required' =>'']) !!}
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 ">CC<span class="text-danger">*</span></label>
            <div class="col-sm-4">
                {!! Form::text('cc', old('cc'), ['class' => 'form-control', 'placeholder' => '','required' =>'']) !!}
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 ">Perihal<span class="text-danger">*</span></label>
            <div class="col-sm-4">
                {!! Form::text('perihal', old('perihal'), ['class' => 'form-control', 'placeholder' => '','required' =>'']) !!}
            </div>
        </div>
        <div class="form-group row">
                                        ...
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Annontation</th>
                                            ...
                                            <?php
                                            $spbitem = getSPBInsurance($item->id,'unit'); ?>
                                            <tbody>
                                                    @php
                                                        $no = 1
                                                    @endphp
                                                    @foreach ($spbitem as $val)
                                                        @php
                                                            $totalharga = $val->price * $val->qtyKoli;
                                                        @endphp
                                                        <tr>
    ...
    <div class="mt-4">
        <a href="{{ route('logistic.insurance_unit.index') }}" class="btn btn-light mr-1 text-uppercase fsz-sm fw-600">{{ trans('Cancel') }}</a>
