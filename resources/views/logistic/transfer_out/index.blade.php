...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Warehouse Transfer Out</li>
    </ol>
@endsection
...
<div class="row mB-40">
	...
	<div class="col-sm-12">
        <div class="bgc-white p-30 bd">
            ...
            <div class="alert alert-info">Pembuatan Transfer Stock dilakukan di Menu Inventory</div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTables').DataTable({
                ...
                serverSide: true,
                "pageLength": 50,
                ajax: '{{ route('logistic.transfer_out.datatables') }}',
                columns: [
            ...
            $('#btn-filter').click( function() {
                $('form#form').attr('action',"{{ route('logistic.transfer_out.search') }}");
                if($('form#form').valid()){
                    $('form#form').submit();
                }
            });
            ...
            $('#btn-export').click( function(e) {
                e.preventDefault();
                $('form#form').attr('action',"{{ route('logistic.transfer_out.export') }}");
                if($('form#form').valid()){
                    $('form#form').submit();
                }
            });
