	...
	<div class="row mB-40">
        <div class="col-sm-12">
            <div class="bgc-white p-20 bd">
                ...
                {!! Form::open([
                        'method' => 'PUT',
                        'route' => ['logistic.master_user_asset.update', Hashids::encode($data->id)]
                    ]) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            {!! Form::text('nik', $data->nik, ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                            <p class="help-block"></p>
                            @if($errors->has('nik'))
                                <p class="help-block">
                                    {{ $errors->first('nik') }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="checkbox" name="status" class="switch switch-info" id="status" value="{{$data->status}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            {!! Form::submit(trans('Update'), ['class' => 'btn btn-danger text-uppercase fsz-sm fw-600']) !!}
                        </div>
                    </div>
                {!! Form::close() !!}
            </div>
