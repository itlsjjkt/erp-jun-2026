<html>
	...
	<body>
			...
			<tr>
				...
				<td class="border-0" style="width:33.3%">
					<table style="width:100%">
						...
						<tr>
							<td style="font-weight:bold;">Estimasi Tiba </td>
		...
		@if($totalPrice >= 250000000)						
			<p style="font-weight:bold; color:red; width:100%; display:flex; justify-content:flex-end;">* Harga lebih dari 250 juta</p>						
		@endif
		@if($spb->jalur_pengiriman)
			<div class="text-center fa-2x jalur">
				{{$spb->jalur_pengiriman}}
			</div>
		@endif

		<p>Adapun perincian barang yang kami kirim sebagai berikut:</p>
				...
				<tr>
					<td colspan="10" style="padding:0px !important">
						<table class="table table-bordered" style="width:100%;margin-top:15px">
							<tr>
								<td  class="p-0 text-center" style="width:14%;">Prepared By</td>
								<td  class="p-0 text-center" colspan="3" style="width:42%;">Checked By</td>
								<td  class="p-0 text-center" style="width:14%;">Hand Over By</td>
								<td  class="p-0 text-center" style="width:14%;">Delivered By</td>
								<td  class="p-0 text-center" style="width:14%;">Received By</td>
							</tr>
							<tr>
								<td></td>
							...
							<tr>
								...
								<td class="p-0 text-center">EDY JAYA SURANTA</td>
							...
							<tr>
								...
								<td  class="p-0 text-center text-uppercase" style="width: 100px !important;">Teknisi/Operational</td>
								<td  class="p-0 text-center text-uppercase">COURIR</td>
