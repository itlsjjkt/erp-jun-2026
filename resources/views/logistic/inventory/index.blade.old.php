        ...
        <div class="bgc-white p-20 bd">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-item">
                            <form class="form-horizontal" action="{{ route('logistic.transfer_out.create')}}" method='GET' id='formTransfer'>
                                {{ csrf_field() }}
                                <input type="hidden" name="inv_id">
                                <button type="submit" class="btn btn-outline font-normal">TRANSFER OUT</button>
                            </form>
                        </li>
                        <li class="dropdown-item">
            ...
            <div class="table-responsive mt-4">
                <div class="alert alert-info">
                    ...
                    <label class='ml-3 badge badge-dark' style="padding: .1em .4em;">&nbsp;</label> Dead Stock
                </div>
...
@section('js')
    ...
    $(document).ready(function() {
        ...
        var table = $('#dataTables').DataTable({
            ...
            serverSide: true,
            "pageLength": 50,
            ajax: '{{ route('logistic.inventory.datatables') }}',
            'columnDefs': [{
                    'targets': 0,
                    'searchable': false,
                    'orderable': false,
