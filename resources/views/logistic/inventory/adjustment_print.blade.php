		...
		<table class="table border-0">
			<tr>
				...
				<td class="border-0 text-right">
                    <span class="text-bold" style="font-weight:bold; font-size: 17px;text-decoration:underline"> ADJUSTMENT STOCK</span> <br>
                    {{ $inventory->doc_no }}
				</td>
			</tr>
        </table>
        
       Terdapat Adjustment Stock Inventory dengan spesifikasi dibawah ini:
		...
		<table class="table table-bordered mt-4">
			<thead>
				<tr>
					...
					<th class="text-center">QTY Fisik (onHand)</th>
			...
			<tbody>
                <tr>
                    ...
                    <td>{{ $inventory->qty_awal }}</td>
                    <td>{{ $inventory->qty_fisik }}</td>
