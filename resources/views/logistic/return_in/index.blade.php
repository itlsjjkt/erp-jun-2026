...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Return In</li>
    </ol>
@endsection
...
<div class="row mB-40">
	...
	<div class="col-sm-12">
        <div class="bgc-white p-30 bd">
            ...
            <div class="row">
                <div class="col">
                    <a href="{{ route('logistic.return_in.list') }}" class="btn btn-danger">
                    Input Return In
                </a>
                </div>
                <div class="col">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTables').DataTable({
                ...
                serverSide: true,
                "pageLength": 50,
                ajax: '{{ route('logistic.return_in.datatables') }}',
                columns: [
            ...
            $('#btn-filter').click( function() {
                $('form#form').attr('action',"{{ route('logistic.return_in.search') }}");
                if($('form#form').valid()){
                    $('form#form').submit();
                }
            });
            ...
            $('#btn-export').click( function(e) {
                e.preventDefault();
                $('form#form').attr('action',"{{ route('logistic.return_in.export') }}");
                if($('form#form').valid()){
                    $('form#form').submit();
                }
            });
