	...
	<div class="col-sm-12">
        <div class="bgc-white p-30 bd">
            <div class="float-right">
                    <a class="btn btn-outline float-right" href="#" title="Print Data" onclick='printExternal("/logistic/return_in_print/{{ Hashids::encode($return_in->id) }}")'><i class="ti-printer icon-lg"></i></a>
            </div>
            ...
            @if ($return_in->status == '0'  )

                <div class="mt-4 btn-group">

                    <a href="{{ route('logistic.return_in.edit',Hashids::encode($return_in->id)) }}" class="btn btn-info mr-1 text-uppercase fsz-sm fw-600">Edit Draft</a>

                    <form class='delete' action="{{ route('logistic.return_in.delete', ['id' => $return_in->id]) }}" method='POST'>
                        {{ csrf_field() }}
